        ...
        <div class="col-md-4 col-md-offset-4">
          ...
          <form action="/gestion_achat/public/add_da" method="post">
            <div class="form-group">
                ...
                <input type="date" class="text form-control" name="delai" value="{{$da->delai}}" placeholder="Selectionner un delai">
                <span class="text-danger">@error('delai'){{ $message }}@enderror</span>
                </div>

                <div class="form-group">
                    <label for="reference">reference</label>
                    <input type="text" class="text form-control" name="reference" value="{{$da->reference}}" placeholder="Entrer une reference">
                    <span class="text-danger">@error('reference'){{ $message }}@enderror</span>
                    </div>

                    <div class="form-group">
                        <label for="qte" >Quantite</label>
                        <input type="text" class="text form-control" name="qte" value="{{$da->qte}}" placeholder="Entrer la quantite">
                ...
                <div class="form-group">
                    ...
                    <input type="code_NE" class="text form-control" name="code_NE" value="{{$da->code_NE}}" placeholder="Enter Code de nature economie">
                    ...
                    <div class="form-group">
                        ...
                        <select name="societe" id="societe" class="select form-control">
                            <option value='{{$da->societe}}'>{{$da->societe}}</option>
                        </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="code_NE" class="text form-control" name="description"  placeholder="Enter une description"></textarea>
                            ...
                            <div class="form-check">
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="radio"  name="validation"  value="" id="flexCheckDefault">
                                <label class="form-check-label" for="flexCheckDefault">
                                  Refuser
                                </label>
                              </div>
                    ...
                    <a href="/gestion_achat/public/logout" class="">Logout</a>
                </form>
        </div>
