   ...
   <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
    ...
    <form action="{{env('APP_URL')}}/manager_add_tab" method="post">
        ...
        @endif
                        ...
                        <div class="mb-3">
                            <label for="formrow-numero-input" class="form-label">Date d'emission : {{ Carbon::parse( $dm[0]->created_at)->format('Y-d-m H:i:s')}}</label>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Les detailles de le tableau comparatif</h4>
