...
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
  ...
  <form action="{{env('APP_URL')}}/manager_edit_dm" method="post" enctype="multipart/form-data" >
        ...
        @endif
                        ...
                        <div class="mb-3">
                            <label for="formrow-numero-input" class="form-label">Motif du retour : {{ $dm[0]->commentaire_manager }}</label>
                        </div>
